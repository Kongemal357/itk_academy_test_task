...
async def test_get_balance_200(unit_client, sample_wallet, mocker):
    ...
    response = await unit_client.get(
        f"/api/v1/wallets/{sample_wallet.uuid}"
    )
...
@pytest.mark.unit
async def test_post_wallet_transaction_404_wallet_not_found(unit_client, sample_wallet, mocker):
    mocker.patch(
        "src.api.v1.routes.wallet.select_wallet_for_update_by_uuid",
        return_value=None
    )
...
@pytest.mark.unit
async def test_post_wallet_transaction_deposit_500_db_connection(unit_client, sample_wallet, mocker):
    mocker.patch(
        "src.api.v1.routes.wallet.select_wallet_for_update_by_uuid",
        side_effect=OperationalError("connection failed", orig=None, params=None),
    )
...
@pytest.mark.unit
async def test_post_wallet_transaction_withdraw_500_db_connection(unit_client, sample_wallet, mocker):
    mocker.patch(
        "src.api.v1.routes.wallet.select_wallet_for_update_by_uuid",
        side_effect=OperationalError("connection failed", orig=None, params=None),
    )
...
@pytest.mark.unit
async def test_post_wallet_transaction_deposit_500_db_error(unit_client, sample_wallet, mocker):
    mocker.patch(
        "src.api.v1.routes.wallet.select_wallet_for_update_by_uuid",
        side_effect=SQLAlchemyError("db error"),
    )
...
@pytest.mark.unit
async def test_post_wallet_transaction_withdraw_500_db_error(unit_client, sample_wallet, mocker):
    mocker.patch(
        "src.api.v1.routes.wallet.select_wallet_for_update_by_uuid",
        side_effect=SQLAlchemyError("db error"),
    )
